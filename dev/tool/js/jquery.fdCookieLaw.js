    ...
    */
    ...
    $.extend(Plugin.prototype, {
        ...
        /* SERVICES & COOKIE USER SETTINGS 
            This update is for cookie user choise */
        /* ############################################################ */
        
        /* ========================================================= */
        /* Accept all services */
        /* ========================================================= */
        /*servicesChoise_acceptAll: function (plugin,"accepted",callbacks) {
            ...
            $.ajax({
                ...
                success: function (config) {
                    ...
                    $.each(config.cookiePolicy.services, function(index) {
                        if (this.active === true) { 
                            $.each(config.cookiePolicy.services[index].services, function(key, value) {
                                if(value === true) plugin.writeCookie(key, value, config.cookieBanner.cookieExpire);
                            });
                        }
                    });
